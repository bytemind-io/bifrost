...
type Log struct {
	...
	Alias                   *string   `gorm:"type:varchar(255);index" json:"alias,omitempty"` // Set when an alias mapping was applied; stores the resolved upstream model identifier (Model holds the alias the caller used)
